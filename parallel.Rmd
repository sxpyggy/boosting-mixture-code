...
#clusterExport(c1, varlist=c("X","maxdepth","cp","lr","M","patience","Pinit","Xval","Yval","node_pre"))
...
t_parallel
stopCluster(c1)
matplot(cbind(bst_fit_parallel$Train_loss,bst_fit_parallel$Valid_loss), type = "l")
abline(v = which.min(bst_fit_parallel$Valid_loss), lty = 3)
min(bst_fit_parallel$Valid_loss)
