...
for(i in 1:J){
  ...
  # MLE of p (given Z)
  bst_p<- BST(X=dat_train[,variables_name], Y=z_hat_train, Pinit=NULL, Xval = dat_valid[,variables_name], Yval=z_hat_valid, Pvalinit = NULL, M=50, cp=0.001, maxdepth = 4, lr=0.2, trace = T, patience = 2)
...
for (i in 1:J) {
  # MLE of p (given Z)
  bst_p<- BST(X=dat_learn[,variables_name], Y=z_hat, Pinit=NULL, Xval = dat_learn[,variables_name], Yval=z_hat, Pvalinit = NULL, M=50, cp=0.001, maxdepth = 4, lr=0.2, trace = T, patience = 2)
