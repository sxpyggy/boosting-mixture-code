...
for (k in 1:5){
barplot(var_imp[,k+1], names.arg = var_imp$var_name,ylab="relative importance",main="relative importance of covariates",ylim=range(var_imp[,-c(1,7)]))
box()
}
barplot(var_imp[,7], names.arg = var_imp$var_name,ylab="relative importance",main="relative importance of covariates")
box()
# dev.off()
