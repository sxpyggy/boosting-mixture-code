...
dat_test$null_mu<-model_homo$test$mu1*model_homo$test$p1+model_homo$test$mu2*model_homo$test$p2+model_homo$test$mu3*model_homo$test$p3
(null_test_mse_mu<-mean((dat_test$Y-dat_test$null_mu)^2))

dat_test$true_mu<-dat_test$MU1*dat_test$P1+dat_test$MU2*dat_test$P2+dat_test$MU3*dat_test$P3
(true_test_mse_mu<-mean((dat_test$Y-dat_test$true_mu)^2))
```
...
dat_test$glm_mu<-model_glm_mu$test$mu1*model_glm_mu$test$p1+model_glm_mu$test$mu2*model_glm_mu$test$p2+model_glm_mu$test$mu3*model_glm_mu$test$p3
(glm_test_mse_mu<-mean((dat_test$Y-dat_test$glm_mu)^2))
```
...
dat_test$glm_p<-model_glm_p$test$mu1*model_glm_p$test$p1+model_glm_p$test$mu2*model_glm_p$test$p2+model_glm_p$test$mu3*model_glm_p$test$p3
(glm_test_mse_p<-mean((dat_test$Y-dat_test$glm_p)^2))
```
...
dat_test$glm_both<-model_glm_both$test$mu1*model_glm_both$test$p1+model_glm_both$test$mu2*model_glm_both$test$p2+model_glm_both$test$mu3*model_glm_both$test$p3
(glm_test_mse_both<-mean((dat_test$Y-dat_test$glm_both)^2))
```
...
dat_test$bst_mu<-dat_test$mu1*dat_test$p1+dat_test$mu2*dat_test$p2+dat_test$mu3*dat_test$p3
(bst_test_mse_mu<-mean((dat_test$Y-dat_test$bst_mu)^2))
```
...
dat_test$bst_p<-dat_test$mu1*dat_test$p1+dat_test$mu2*dat_test$p2+dat_test$mu3*dat_test$p3
(bst_test_mse_p<-mean((dat_test$Y-dat_test$bst_p)^2))
```
...
dat_test$bst_both<-dat_test$mu1*dat_test$p1+dat_test$mu2*dat_test$p2+dat_test$mu3*dat_test$p3
(bst_test_mse_both<-mean((dat_test$Y-dat_test$bst_both)^2))
```
...
mu_bst0 <- gbm(c(Y,Yval) ~ ., data = rbind(X,Xval),
                       distribution = "gaussian", n.trees = M0,
                       interaction.depth = 4, shrinkage =shrinkage0,
                       bag.fraction = 1,
                       train.fraction = length(Y)/(length(Y)+length(Yval)),
                       verbose = T)
 
mu_iter0<- gbm.perf(mu_bst0,plot.it = T)
dat_test$mu0<-predict(mu_bst0,newdata = dat_test, n.trees =mu_iter0)
dat_test$sigma0<-sqrt(mean((dat_test$Y-dat_test$mu0)^2))
(bst_test_mse_0<-mean((dat_test$Y-dat_test$mu0)^2))
```
