...
It seems that the component means are not related to covariates.
...
It shows that the boosting cannot find heterogeneity in component means and the boosting stops early at very beginning. 
We calculate the overall relative importance of $x_1,x_2,x_3,x_4$ in mixing probabilities as $48.23,34.51,17.00,0.25$, which is align to the underlying model.
\begin{figure}[htp!]
		\centering
...
\begin{figure}[htp!]
	...
	\caption{The trace plot of loss during the boosting iterations for component means  at last EB iteration $T$.}\label{gaussian-comp}
\end{figure} 
...
Comparison of the running times without parallel computing for models \eqref{gaussian-bst-mu} and \eqref{gaussian-bst-p} implies that the boosting of mixing probabilities takes much more time than the boosting of component means does.
Indeed, the boosting iteration of component means stop early while the boosting iteration of mixing probabilities takes more time to discover the heterogeneity; see the underlying model \eqref{gaussian-true}. 
We accelerate the EB algorithm by applying parallel computing for the boosting of mixing probabilities, i.e., in loop 6-9 of Algorithm \ref{EB} we fit $K$ trees simultaneously.
